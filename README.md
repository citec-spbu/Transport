...
О проекте
---
Проект разработан в рамках научно-исследовательской работы по анализу городских транспортных сетей с применением методов теории графов и машинного обучения. Целью работы является создание инструмента для комплексного анализа структуры общественного транспорта в городах различного масштаба, выявления закономерностей в организации маршрутной сети и поиска оптимальных решений для повышения эффективности транспортной системы.

**Основные задачи проекта:**
- Автоматизация сбора и обработки данных о маршрутах общественного транспорта
- Построение и анализ графовых моделей транспортных сетей
- Применение алгоритмов кластеризации для выявления транспортных зон и узловых районов
- Вычисление метрик центральности для определения ключевых остановок и пересадочных узлов
- Визуализация результатов анализа для поддержки принятия управленческих решений

**Результаты работы:**
- Разработано веб-приложение с современным технологическим стеком (FastAPI, React, Neo4j)
- Реализована интеграция с Graph Data Science для применения продвинутых алгоритмов анализа графов
- Создан удобный веб-интерфейс для работы с данными и визуализации результатов
- Обеспечена возможность анализа транспортных сетей различных городов
